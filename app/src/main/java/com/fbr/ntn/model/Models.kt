...
data class PendingItem(
    ...
    val period: String,
    val dueLabel: String,
    val sellerName: String = "ZEENO TRADERS (PVT.) LTD.",
    val sellerLogoUrl: String = "",
    val sellerNtn: String = "1234567-8",
    val sellerStrn: String = "3277876543210",
    val sellerAddr: String = "Street 12, Industrial Estate, Faisalabad",
    val sellerContact: String = "sales@zeeno.example | +92 41 1234567",
    val buyerNtn: String = "",
    val buyerStrn: String = "",
    val buyerAddr: String = "",
    val buyerRegType: String = "Registered",
    val paymentTerms: String = "Credit - payable within 30 days.",
    val saleType: String = "Goods at standard rate",
    val fbrInvoiceNo: String = "",
    val validationCode: String = "00 - Valid",
    val scenario: String = "SN001 - Registered person",
